...
namespace gui {
	...
	void FocusHandler::requestFocus(Widget* widget)
	{
		...
		{
			throw GUI_EXCEPTION("Trying to focus a none existing widget.");
		}
	...
	void FocusHandler::requestModalFocus(Widget* widget)
	{
		...
		{
			throw GUI_EXCEPTION("Another widget already has modal focus.");
		}
	...
	void FocusHandler::requestModalMouseInputFocus(Widget* widget)
	{
		...
		{
			throw GUI_EXCEPTION("Another widget already has modal input focus.");
		}
